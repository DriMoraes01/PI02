<div class="page-wrap">
    <div class="app-sidebar colored">
        <div class="sidebar-header" style="background-color: Teal;">
            ...
            <div class="nav-container">
                <nav id="main-menu-navigation" class="navigation-main">
                    ...
                    <div class="nav-item has-sub">
                        ...
                        <div class="submenu-content" style="background-color: CadetBlue;">
                    ...
                    <?php if ($this->ion_auth->is_admin()) : ?>
                        <div class="nav-lavel" style=" background-color: DarkCyan;"><span style="color: #f2f3ef; font-family: 'Roboto', sans-serif; font-size: 16px;">Administração</span></div>
